    ...
    <div>
      <StMainBackground>
        ...
        <Body>
          ...
          <StCategoryBar>
            <StCategoryWrap>
              <StCatergoryItem style={{ color: colors.mainBlue }}>
                All
              </StCatergoryItem>
              <StLine />
            ...
            <StArticlesWrap>
              <StArticleCard>
                ...
                <StArticleContentInfoWrap>
                  ...
                  <StArticleContentTxt style={{ margin: 0 }}>
                    내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용
                  </StArticleContentTxt>
                </StArticleContentInfoWrap>
