        ...
        <Style.StArticlesWrap>
          <Style.StArticleCard>
            ...
            <Style.StArticleContentInfoWrap>
              <Style.StArticleTitle>
                파스타를 먹었습니다
              </Style.StArticleTitle>
              <Style.StArticleContentTxt>
                파스타의 한 종류입니다. 이처럼 파스타는 형태에 따라 약 350가지가 넘는 다양한 종류가 있습니다. 원료는 듀럼밀 세몰리나로 동일하지만 용도 및 이탈리
              </Style.StArticleContentTxt>
            </Style.StArticleContentInfoWrap>
            ...
            <Style.StContentStats>
              <div style={{ display: 'flex' }}>
                <Style.StIconsStatsWrap>
                  <Style.StIconWrap><FiEye /></Style.StIconWrap> <span>0</span>
                </Style.StIconsStatsWrap>
                <Style.StIconsStatsWrap>
                  <Style.StIconWrap><LiaCommentDots /></Style.StIconWrap> <span>0</span>
                </Style.StIconsStatsWrap>
              </div>
              <Style.StIconsStatsWrap >
                <Style.StIconWrap><FcLike /></Style.StIconWrap> <span>0</span>
              </Style.StIconsStatsWrap>
            </Style.StContentStats>
          </Style.StArticleCard>
